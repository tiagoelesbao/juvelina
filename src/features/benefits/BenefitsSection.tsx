        ...
        >
          ...
          >
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 mb-8">
              <div className="bg-white p-5 rounded-lg shadow-md hover:shadow-lg transition-all border-l-4 border-red-500">
              ...
              <div className="bg-white p-5 rounded-lg shadow-md hover:shadow-lg transition-all border-l-4 border-juvelina-emerald">
          ...
          >
            ...
            <motion.div
              className="absolute top-5 left-5 bg-juvelina-gold text-white px-4 py-2 rounded-lg shadow-lg"
              initial={{ opacity: 0, x: -20 }}
              animate={{ opacity: 1, x: 0 }}
              transition={{ delay: 0.5, duration: 0.5 }}
            >
              {activeTab === 'energy' && <span className="font-bold">97% relatam mais energia</span>}
              {activeTab === 'immunity' && <span className="font-bold">89% percebem menos doenças</span>}
              {activeTab === 'beauty' && <span className="font-bold">92% notam pele e cabelos melhores</span>}
              {activeTab === 'absorption' && <span className="font-bold">5x mais absorção comprovada</span>}
            </motion.div>
          </motion.div>
        </motion.div>
      </div>
